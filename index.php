...
<div class="container g-0">
  <div class="px-3 pt-3 " >
    ...
    <div class="trl-progressbar mt-3 rounded-5 position-relative">
      <div style="width: 10%;" class="trl-progressbar__filled py-2  trl-gr-blue rounded-5 d-flex justify-content-center"></div>
      <span style="margin-top: 1px" class="text-uppercase lh-1 font-14 position-absolute start-50 top-50 translate-middle">rolling in 12.35</span>
    </div>
    ...
    <div class="trl-bg rounded-5 py-2 px-2 d-flex  justify-content-center trl-players-bets__list overflow-auto" style="max-height: 195px">
      <div class="row g-0">
        <div class="col-6">
          <div class="trl-player-bet rounded-5 px-2 py-1 d-flex align-items-center trl-bg-light-2 mx-1 my-1">
            ...
            <div class="ms-auto me-2">
              <div class="trl-gr-green p-1 d-inline-block lh-1 rounded-3 text-uppercase opacity-25">X12</div>
            </div>
            <div>
        ...
        <div class="col-6">
          ...
          <div class="ms-auto me-2">
            <div class="trl-gr-blue p-1 d-inline-block lh-1 rounded-3 text-uppercase opacity-25">X12</div>
          </div>
          <div>
        ...
        <div class="col-6">
          ...
          <div class="ms-auto me-2">
            <div class="trl-gr-yellow p-1 d-inline-block lh-1 rounded-3 text-uppercase opacity-25">X12</div>
          </div>
          <div>
        ...
        <div class="col-6">
          <div class="trl-player-bet rounded-5 px-2 py-1 d-flex align-items-center trl-bg-light-2 mx-1 my-1">
            ...
            <div class="ms-auto me-2">
              <div class="trl-gr-red p-1 d-inline-block lh-1 rounded-3 text-uppercase opacity-25">X12</div>
            </div>
            <div>
    ...
    <div class="mt-3 trl-bg rounded-5 px-3 py-2 d-md-flex">
      ...
      <div class="d-flex mt-2 mt-md-0">
        <div class="btn-bet me-2 rounded-5 fw-bold text-center font-22 px-3 py-2 w-50 trl-gr-yellow">Bet x2</div>
...
<div class="trl-menu trl-bg position-fixed start-0 d-flex justify-content-around align-items-center justify-content-between text-center bottom-0 w-100 px-3">
    <div class="trl-menu__item"><img src="/assets/img/rules.png" alt=""><span class="font-12 lh-0 mt-1 d-block">Rules</span></a></div>
    <div class="trl-menu__item"><img src="/assets/img/game.png" alt=""><span class="font-12 lh-0 mt-1 d-block">Game</span></a></div>
    <div class="trl-menu__item"><img src="/assets/img/chat.png" alt=""><span class="font-12 lh-0 mt-1 d-block">Chat</span></a></div>
    <div class="trl-menu__item"><img src="/assets/img/gifts.png" alt=""><span class="font-12 lh-0 mt-1 d-block">Gifts</span></a></div>
    <div class="trl-menu__item"><img src="/assets/img/menu.png" alt=""><span class="font-12 lh-0 mt-1 d-block">Menu</span></a></div>
</div>
