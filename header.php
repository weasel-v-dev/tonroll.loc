    ...
    <div class="px-2 pt-2">
        ...
        <div class="d-flex align-items-center">
            ...
            if($_SERVER['REQUEST_URI'] == "/" || $_SERVER['REQUEST_URI'] == "/index.php") { ?>
                ...
                <div class="trl-avatar mx-auto trl-bg-green-blue d-flex justify-content-center align-items-center rounded-4">
            ...
            <?php } else { ?>
                ...
                <div class="trl-avatar ms-2 me-auto trl-bg-green-blue d-flex justify-content-center align-items-center rounded-4">
                  <img src="/assets/img/plug/avatar.png" alt="" >
                </div>
            <?php } ?>
    <div class="d-flex align-items-center trl-bg rounded-4 p-1">
