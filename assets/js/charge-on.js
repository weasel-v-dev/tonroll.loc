...
const chargesOn = JSON.parse(JSON.stringify([
    {
        id: 1,
        amount: '12000',
...
function displayItems(page) {
    ...
    let itemsToDisplay = chargesOn.slice(start, end);
...
let totalPages = Math.ceil(chargesOn.length / ITEMS_PER_PAGE);
displayItems(currentPage);
displayPaginationControls(currentPage, totalPages);
