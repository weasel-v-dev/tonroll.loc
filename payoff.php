...
<div class="p-2 trl-bg mt-2 rounded-5 ">
    <h1 class="mb-0 font-18 text-center">Выплата на Tinkoff
    </h1>
</div>
...
<div class="p-2 trl-bg mt-2 rounded-5 text-center">
  ...
  <div class="mb-2">
    <div class="font-12">Введите кошелек</div>
  ...
  <div class="pb-1">
    <button type="submit" class="btn-bet lh-1 rounded-4 fw-bold text-center font-14 px-3  py-2 trl-gr-green">Заказать выплату</button>
  </div>
</div>
  <div class="d-flex align-items-center mt-2">
  ...
  border-spacing: 0 5px;">
        ...
        <tr>
          ...
          <th scope="col" class="border-0 p-0 text-center">Кошелёк</th>
        ...
        <tbody>
          ...
          <td class="border-0">
            <div class="text-center"><span  class="trl-gr-black lh-1 p-1 d-inline-block rounded-3">Txk345dfg...hgRTB</span></div>
          </td>
          <td class="border-0">
