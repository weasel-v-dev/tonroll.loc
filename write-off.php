...
<div class="p-2 trl-bg mt-2 rounded-5 ">
    <h1 class=" font-18 text-center">Заказать выплату
    </h1>
    <form action="" class="text-center ">
      ...
      <div class="">
        <button type="submit" class="btn-bet lh-1 rounded-4 fw-bold text-center font-14 px-3  py-2 trl-gr-green">Выплатить</button>
